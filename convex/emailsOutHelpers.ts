  ...
  handler: async (ctx, args) => {
    ...
    return {
      ...
      workspace: {
        ...
        emailLogoUrl: wsCtx.workspace.emailLogoUrl,
        emailPhysicalAddress: wsCtx.workspace.emailPhysicalAddress,
        emailSocialLinks: wsCtx.workspace.emailSocialLinks,
      },
      owner: {
        name: wsCtx.user.name,
      },
      senderIdentity,
      resendApiKey,
