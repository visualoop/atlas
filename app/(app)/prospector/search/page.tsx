  ...
  return (
    <>
      <header className="space-y-2 mb-8">
        <p className="eyebrow">Prospector · Text search</p>
        <h1 className="text-3xl md:text-4xl tracking-tight">
          Ask in plain English, <em className="italic font-display">get ranked leads</em>.
        </h1>
        <p className="text-sm text-muted-foreground max-w-prose">
          Powered by Google Places. Rejected leads are suppressed on
          future runs so you never see them twice.
        </p>
      </header>
