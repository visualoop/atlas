      ...
      <div className="relative bg-muted min-h-[50vh] lg:min-h-0">
        ...
        <div className="absolute top-2 left-2 right-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 z-[400]">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 h-9 px-4 bg-primary text-primary-foreground text-xs font-mono uppercase tracking-[0.12em] shadow disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
